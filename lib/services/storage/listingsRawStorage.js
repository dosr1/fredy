 ...
 * Uses global fetch (Node 18+) — if your Node < 18 install undici or node-fetch.
 */
...
export async function saveRawPictures(listingId, pictures = []) {
  ...
  // Use a synchronous transaction to insert BLOBs (better-sqlite3 is sync)
...
/**
 * Optional helper: remove raw rows for a listing (used on delete/update).
 */
